...
// ============================================
const NEGOCIO = {
  nombre: "Belén Castilla Estética Avanzada",
  tipo: "centro de estética avanzada",
  ciudad: "Churriana de la Vega (Granada)",
  direccion: "C. San Ramón, 108, 18194 Churriana de la Vega, Granada",
  telefono: "615 32 21 65",
  whatsapp: "34615322165",
  horario: "Lunes a viernes de 9:00 a 21:00 y sábados de 9:00 a 14:00. Domingos cerrado.",
  servicios: `- Depilación Láser Diodo (axilas, ingles, piernas)
- Uñas y Manicura (gel, esmaltado semipermanente, extensiones, pedicura)
- Depilación con Cera (cejas, labio, piernas, zonas íntimas)
- Faciales Avanzados (limpieza profunda, radiofrecuencia, acupuntura estética)
- Pestañas y Cejas (extensión, lifting, diseño con hilo, tinte)
- Maquillaje (tradicional, semipermanente, también a domicilio para bodas y eventos)
- Tratamientos Corporales (parafina, masaje)
No hay precios fijos publicados: para cualquier precio, di que depende de la zona/tratamiento y que se confirma por WhatsApp o en el centro.`,
  instrucciones_extra: `- No inventes precios en euros bajo ningún concepto, no los tenemos publicados
- El local tiene acceso y baño adaptados para sillas de ruedas, menciónalo si preguntan por accesibilidad
- Ana Belén es la dueña, "Cristi" trabaja también en el centro — puedes nombrarlas si preguntan quién les atenderá`
}
// ============================================
