...
REM
REM  Enlace bueno: https://belen.creskio.com
REM ============================================================
cd /d "E:\Escritorio\DEMOS ESTETICAS\Belen Castilla Estetica Avanzada"

echo.
echo  Publicando Belen Castilla
echo  --------------------------------------------
echo.
